...
<html>
<head>
    <title>Recommendations - Netcheap</title>
    ...
    <div id="main-page">
        <div id="nav-bar">
            ...
            <div id="nav-links">
                ...
                <a class="link" href="../pages/mes-recommendations.php"><strong>Mes recommendations</strong></a>
            </div>
            <div id=nav-right>
                <div id="search-bar">
            ...
            <div class="caroussel_container">
                ...
                <div class="all_thumb_container_maliste">
                        <?php
                            ...
                            array("user_id" => $_SESSION['user_id'], "limit" => 30, "sort" => -1));
